<%@ page title="Change Password" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Account_ChangePassword, App_Web_changepassword.aspx.dae9cef9" theme="efot" %>
            ...
            <div class="accountInfo">
                ...
                <p class="submitButton">
                    ...
                    <asp:Button ID="CancelPushButton" runat="server" CausesValidation="False" 
                        CommandName="Cancel" Text="Cancelar" onclick="CancelPushButton_Click"/>
                </p>
            </div>
