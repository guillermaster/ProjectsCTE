<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" CodeFile="Registro.aspx.cs" theme="efot" Inherits="Registro" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        ...
        <asp:Panel runat="server" ID="pnlForm1">
            ...
            <asp:RegularExpressionValidator ID="regExpValFecNac" runat="server" 
                ControlToValidate="txtFecNac" ErrorMessage="Solo se aceptan personas nacidas entre 01/01/1986 y 01/01/1989" 
                ValidationExpression="^([1-9]|1[012])[- /.]([1-9]|[12][0-9]|3[01])[- /.](1986|1987|1988|1989)$"  
