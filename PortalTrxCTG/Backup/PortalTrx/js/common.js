...
function popupAndWriteHtml(width, height, scrollbars, id, html) {
    ...
    popWin.document.write("<html><head><title>CTE - Código Electrónico de Pago</title>");
    ...
    popWin.document.title = "CTE - Código Electrónico de Pago";
    popWin.document.close();
    //popWin.print();
}

function DisplayDropDownListEditText(txtId, ddlId) {
    var ddl = document.getElementById(ddlId);
    document.getElementById(txtId).value = ddl.options[ddl.selectedIndex].text;
