...
namespace Constantes
{
    public class UsuarioWeb
    {
        ...
        public static readonly string SessionUserNames = "userNames";
        public static readonly string SessionUserLastNames = "userLastNames";
        public static readonly string SessionUserEmail = "userEmail";
        public static readonly string SessionUserLastAccess = "userLastAccess";
        ...
        public static readonly string ErrorMsgEmailAlreadyExists = "El correo electrónico ingresado se encuentra asociado a otra cuenta, debe ingresar uno diferente.";
