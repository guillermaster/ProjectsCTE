...
namespace Brevetacion
{
    public class ExamenPractico
    {
            ...
            try
            {
                if (oDatos.Ejecutar("R"))
                {
                    if (oDatos.RetornarParametro("pv_error").ToString() == "S")
                    {
                        ...
                        _error = "Error al consultar turnos para examen práctico";
                }
                else
                    _error = "Error al consultar turnos para examen práctico";
            }
        ...
        public DataTable GetCalificacionesExamenByIdUser(string identificacion)
        {
            ...
            dt.Columns.Add("Código de examen");
            dt.Columns.Add("Fecha de examen");
            dt.Columns.Add("Nota");
            dt.Columns.Add("¿Aprobó?");
            ...
            try
            {
                if (oDatos.Ejecutar("R"))
                {
                    ...
                    {
                        _error = "Error al consultar notas de examen práctico.";
                    }
                }
                else
                {
                    _error = "Error consultando notas de examen práctico";
                }
            }
            catch
            {
