    ...
    public class MatriculacionVehicular
    {
        ...
        public DataTable VehiculosPorPersona(string licencia)
        {
            ...
            try
            {
                ...
                {
                    error = "No se pudo conectar a la Base de Datos, por favor intente nuevamente más tarde.";
                }
            }
            catch (Exception ex)
            {
        ...
        public DataTable HistorialMatriculacion(string placa)
        {
            ...
            dtMatriculacion.Columns.Add("Año de matrícula");
            dtMatriculacion.Columns.Add("Emisión");
            dtMatriculacion.Columns.Add("Caducidad");
            dtMatriculacion.Columns.Add("Tipo de matrícula");
            dtMatriculacion.Columns.Add("Tipo de cobro");
