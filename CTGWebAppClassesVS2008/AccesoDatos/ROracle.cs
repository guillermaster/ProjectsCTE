    ...
    public class ROracle
    {
        ...
        public ROracle(string sUsuario, string sClave, string sBaseDatos)
        {
            /*_sConexion = "Data Source=" + sBaseDatos +
                ...
                "; Password=" + sClave +
                "; Pooling=False";*/
            _sConexion = "User Id=" + sUsuario + ";Password=" + sClave + ";Data Source=" + sBaseDatos + ";" + 
                "Max Pool Size=2; Connection Timeout=60;";
        ...
        public void Parametro(string sParametro, string sTipo, Int32 iLong, string sDireccion, string sValue)
        {
            ...
            _oComando.Parameters.Add(sParametro, oTipo, iLong, sValue, oDireccion);
        ...
        public DataSet RetornarDatosCursores()
        {
            Oracle.DataAccess.Client.OracleDataAdapter da = new Oracle.DataAccess.Client.OracleDataAdapter(_oComando);
