...
<body>
    ...
    <div style="height:10px">
        ...
        <div style="margin: 40px 20px 20px 25px;">
             ...
             <table class="error2" align="center" width="480">
                <tr>
                    ...
                    <td><asp:Label ID="lblMsgError" runat="server" Font-Size="Small" Font-Bold="False"></asp:Label><br />
                        <asp:HyperLink ID="hypRetryLoadExam" runat="server" Visible="False" NavigateUrl="Cuestionario.aspx">Haga clíc aquí para intentar cargar el examen nuevamente</asp:HyperLink></td>
                </tr>         
              </table>
            </div>
            <div id="divOK" runat="server">
          <div id="divCuestionario" style="height:150px">
            <asp:Label ID="lblNoPregunta" runat="server" CssClass="h1"></asp:Label>
            <br /><br /><br />
            ...
            <asp:GridView ID="gvRadioAnswers" runat="server" Visible="False" AutoGenerateColumns="False" GridLines="None" ShowHeader="False">
                ...
                <td width="30%"><asp:Image ID="imgFoto" runat="server" ImageAlign="Left" ImageUrl="imagenPregunta.aspx" /></td>
             </tr>
            </table>
            </div>
            <table width="100%">
