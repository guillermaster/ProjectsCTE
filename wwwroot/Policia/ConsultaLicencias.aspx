...
<body>
    ...
    <div>
           ...
           <h3>Reporte de Datos de Licencia</h3>
                ...
                <table>
                  <tr>
                    ...
                    <td style="height: 34px">
                        <asp:ImageButton ID="btnVerVehiculos" runat="server" 
                            ImageUrl="~/img/iconCar.png" ToolTip="Ver vehiculos de esta persona" 
                            CssClass="helpText" PostBackUrl="~/VehiculosPorPersona.aspx" Visible="False" />
                          </td>
                  </tr>
                  <tr>
          ...
          <table style="width: 89%">
            ...
            <tr>
             ...
             <table>
              ...
              <tr><td>Sexo:</td><td><asp:Label ID="lblSexo" runat="server" Text=""></asp:Label></td></tr>
        ...
        <div id="datosBasicos" visible="false" runat="server">
          <table style="width: 89%">
            <tr>
              <td width="50%" valign="top">
               <table>
                <tr><th colspan="2">Datos Personales</th></tr>
                <tr><td>Nombre:</td><td><asp:Label ID="lblNombre2" runat="server" Text=""></asp:Label></td></tr>
                <tr><td>Fecha de Nacimiento:</td><td><asp:Label ID="lblFechaNacimiento2" runat="server" Text=""></asp:Label></td></tr>
                <tr><td>Lugar de Nacimiento:</td><td><asp:Label ID="lblLugarNacimiento2" runat="server" Text=""></asp:Label></td></tr>
                <tr><td>Provincia de Nacimiento:</td><td><asp:Label ID="lblProvinciaNacimiento2" runat="server" Text=""></asp:Label></td></tr>
                <tr><td>País de Nacimiento:</td><td><asp:Label ID="lblPaisNacimiento2" runat="server" Text=""></asp:Label></td></tr>
               </table>
              </td>
            </tr>
            <tr>
             ...
             <table>
              ...
              <tr><td>Estatura:</td><td><asp:Label ID="lblEstatura2" runat="server" Text=""></asp:Label></td></tr>
              <tr><td>Tipo de Sangre:</td><td><asp:Label ID="lblTipoSangre2" runat="server" Text=""></asp:Label></td></tr>
              <tr><td>Estado Civil:</td><td><asp:Label ID="lblEstadoCivil2" runat="server" Text=""></asp:Label></td></tr>
              <tr><td>Profesión:</td><td><asp:Label ID="lblProfesion2" runat="server" Text=""></asp:Label></td></tr>
            </table>
             </td>
             <td width="50%" valign="top">
            <table>
              <tr><th colspan="2">Datos de Residencia</th></tr>
              <tr><td>País:</td><td><asp:Label ID="lblPaisRes2" runat="server" Text=""></asp:Label></td></tr>
              <tr><td>Provincia:</td><td><asp:Label ID="lblProvinciaRes2" runat="server" Text=""></asp:Label></td></tr>
              <tr><td>Cantón:</td><td><asp:Label ID="lblCantonRes2" runat="server" Text=""></asp:Label></td></tr>
              <tr><td>Dirección:</td><td><asp:Label ID="lblDireccionRes2" runat="server" Text=""></asp:Label></td></tr>
              <tr><td>Teléfono:</td><td><asp:Label ID="lblTelefonoRes2" runat="server" Text=""></asp:Label></td></tr>
              <tr><td>Teléfono Móvil:</td><td><asp:Label ID="lblCelular2" runat="server" Text=""></asp:Label></td></tr>
            </table>
             </td>
            </tr>
          </table>            
