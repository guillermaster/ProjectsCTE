    ...
    <div align="center">
        ...
        <table style="width: 463px" id="tblChangePwd" runat="server">
            <tr><td colspan="3" class="error">Esta aplicación es de uso exclusivo para personal 
                de la Comisión de Tránsito de la provincia del Guayas. <br /><br /> <b>Esta es la primera vez que va a ingresar a la aplicación, por lo cual deberá cambiar la contraseña asignada por una que usted desee.</b></td></tr>
