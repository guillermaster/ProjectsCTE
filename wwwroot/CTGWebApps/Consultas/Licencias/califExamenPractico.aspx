<%@ Page Language="C#" AutoEventWireup="true" CodeFile="califExamenPractico.aspx.cs" Inherits="Consultas_Licencias_turnoExamenPractico" %>
...
<body>
    <form id="form1" runat="server">
       <h2>Calificaciones de Examen Práctico</h2>  
        ...
        <div>
           <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div>
                <asp:GridView ID="gvCalifExamen" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" Width="520px">
                    ...
                    <Columns>
                        <asp:BoundField DataField="cod_examen" HeaderText="C&#243;digo Examen"  >
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle Width="20%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="fec_examen" HeaderText="Fecha Examen">
                            <ItemStyle HorizontalAlign="Center" />
                        ...
                        <asp:BoundField DataField="aprobo" HeaderText="Estado">
                            <ItemStyle HorizontalAlign="Center" />
