<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="Cuestionarios_index" %>
...
<body>
    ...
    <br /><br /><br />
    <div align="center">
        <asp:HyperLink ID="hypComenzar" runat="server" ImageUrl="~/img/cuestinarios_btn_comenzar.jpg" NavigateUrl="~/Cuestionarios/Cuestionario.aspx"></asp:HyperLink>
    </div>
    </form>
</body>
</html>
