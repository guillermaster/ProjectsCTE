...
function popupAndWriteHtml(url, width, height, scrollbars, id, html)
{
    popWin = window.open(url, id, 'toolbar=0,scrollbars='+scrollbars+',location=0,statusbar=0,menubar=0,resizable=0,width='+width+',height='+height);
}
