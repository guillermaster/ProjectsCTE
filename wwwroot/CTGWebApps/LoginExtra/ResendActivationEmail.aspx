<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResendActivationEmail.aspx.cs" Inherits="LoginExtra_ResendActivationEmail" %>
...
<body>
    ...
    <h2>Reenvío de E-Mail de Activación</h2>
    <asp:Label ID="lblMensaje" runat="server" Text="Ingrese su nombre de usuario (cédula) para que recibe su mensaje de activación."></asp:Label>&nbsp;
