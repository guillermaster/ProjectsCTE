<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="ConsLicencias, App_Web_conslicencias.aspx.cdcab7d2" theme="SkinFile" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="hlpMsgNameSrch" style="float:left; margin: 0; display: none;">
                    <div class="info2">
                        Para buscar por nombre ingrese en el<br /> siguiente orden: APELLIDOS NOMBRES,<br /> además puede utilizar el comodín %,<br /> por ejemplo: Piguave % Juan.
                    </div>
                </div>
