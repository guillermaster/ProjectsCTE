...
function loadMap() {
    ...
    map.setCenter(new GLatLng(-2.202239, -79.929979), w > 700 ? 9 : 7);
...
Info.prototype.show = function () {
    ...
    var imarker = markers[this.id];
    var texto = this.text;
    var name = this.location_name;
    GEvent.addListener(markers[this.id], "click", function () { imarker.openInfoWindowHtml("<div><b>" + name + "</b><br />" + texto + "</div>"); });
