<%@ page language="C#" autoeventwireup="true" inherits="charts_ChartConsPlacas, App_Web_chartconslicencias.aspx.cdcab7d2" theme="SkinFile" %>
...
<body>
    <form id="form1" runat="server">
        <div style="width: 100%; float: left;">
            <div style="text-align:center"><h2>Consultas de Licencias</h2></div>
            <div id="aux">
            </div>
