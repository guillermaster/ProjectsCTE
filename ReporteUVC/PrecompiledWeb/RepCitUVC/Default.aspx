<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="_Default, App_Web_default.aspx.cdcab7d2" title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
    ...
    <asp:Label ID="lblHasta" runat="server" Text="Desde:" />
    <asp:TextBox ID="txtHasta" runat="server" />
    <asp:Button ID="btnConsultar" runat="server" OnClick="btnConsultar_Click" Text="Consultar" /></div>
<div id="aux"></div>
<canvas id="chart" width="600" height="500"></canvas>

    <asp:GridView ID="gvChartData" CssClass="chartData" OnRowDataBound="GridView_RowDataBound" runat="server">
